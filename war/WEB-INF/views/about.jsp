...
<div id="framecontentLeft">
	<div class="innertube">
		<div id="home">
			...
			<div>
				<div class="lang">
			            <c:url var="englishLocaleUrl" value="about">
			                <c:param name="locale" value="en" />
			            </c:url>
			            <c:url var="dutchLocaleUrl" value="about">
...
<div id="framecontentRight">
	...
	<div id="maincontent">
		<div class="innertubemain">
			<h3>poetryfeeder</h3>
				<div class="poem">
					<spring:message code="text.about.intro"/>
					<div class="aboutmeta">
						<p><spring:message code="text.about.main"/></p>
			<ol>
				<li>
					<spring:message code="text.about.1"/>
				</li>
				...
				<li>
					<spring:message code="text.about.5"/>
				</li>
			</ol>
			<p><spring:message code="text.about.colofon"/></p>
